<template>
  <div class="row">
    <div class="typography-document-samples row-fluid">
      ...
      <div class="col-xlg-3 col-lg-6  col-md-6 col-sm-6 col-xs-12 typography-widget">
        <vue-panel class="with-scroll color-widget" vue-panel-title="Text Color">
    ...
    <div class="row-fluid">
      <div class="col-lg-12 col-sm-12 col-xs-12">
        <vue-panel class="banner-column-panel">
          <div class="banner">
            <div class="large-banner-wrapper"><img src="~img/app/typography/banner.png" alt=""/></div>
          ...
          <div class="section">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="img-wrapper">
                  <img src="~img/app/typography/typo03.png" alt="" title=""/>
                </div>
              ...
              <div class="col-sm-6">
                <div class="img-wrapper">
                  <img src="~img/app/typography/typo01.png" alt="" title=""/>
                </div>
            ...
            <div class="row">
              <div class="col-sm-4">
                ...
                <div class="img-wrapper"><img src="~img/app/typography/typo04.png" alt=""/></div>
