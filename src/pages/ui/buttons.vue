<template>
  <div class="widgets">
    <div class="row">
      <vue-panel class="col-md-3 with-scroll button-panel" vue-panel-title="Flat Buttons">
      ...
      <vue-panel class="col-md-3 with-scroll button-panel" vue-panel-title="Raised Buttons">
